			...
			<div id="sidebar" class="nav-collapse ">
				...
				<ul class="sidebar-menu">
					...
					<li class="sub-menu"><a href="javascript:;" class=""> <span>Key Management</span>
						...
						<ul class="sub">
							<li><a class="" href="uploadkey.jsp">Upload keys</a></li>
							<li><a class="" href="keys?type=view">View keys</a></li>
						</ul></li>
				...
				<div class="col-md-12">
					<section class="panel">
						<header class="panel-heading">
							<h3 class="welcome1">Welcome <span class="username"><%=u1.getFname()%> <%=u1.getLname()%></span></h3>
						...
						<div class="panel-body" style='min-height:600px;'>
							...
							%>
						<h4 class="welcome2" style="font-size:2.5em; text-align:center;">Welcome to Security Ecosystem</h4><br>
						
						<img src="img/cube.gif" class="gify" width=20% height=20%/>
						
						
						
						<h5 class="welcome2"><b>Created by:</b><br><br>
						Asha Arvind Birajdar<br><br>
						 Vaishakh Anil Kumar<br><br>
						 Vijayakumar V<br><br>
						 Vyshnavi S P<br><br><br>
						with the guidance of <b>Professor Rajesh Kumar S</b> at Cambridge Institute of Technology</h5>
						</div>
					</section>
				</div>
